              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="widgetMember">
                    <div class="well">
                      <form action="membership_process.php" method="GET">
                        <h2 id="basicPlan">Basic Plan</h2>
                      <h1>189/mo.</h1>
                      <input type="text" class="form-control hidden" name="plan_type" id="plan_type" Value="Basic Plan" >
                       <input type="text" class="form-control hidden" name="plan_price" id="plan_price" Value="189/mo.">
                        <button class="universalButtonRed" type="submit">Buy Now</button>
                      </form>
                    </div>
                  </div>
                </div>
...
<script>
  function passData() {
   var getInput = document.getElementById("basicPlan").value;
