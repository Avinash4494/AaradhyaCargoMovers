...
<!DOCTYPE html>
<html>
  <title>Blogs Report - <?php echo $row["Fullname"]; ?></title>
    ...
    <div class="row">
      <div class="col-lg-2 hidden-xs">
        <div class="leftPannel">
          ...
          <?php include_once 'sideNavBlog.php' ?>
        </div>
      </div>
      <div class="col-lg-10">
        <div class="rightPannelProfile" >
          <div class="dashIntro">
            <div class="rightPaggignation" >
              <div class="row">
                <div class="col-lg-4">
                  <h3><a href="../AdminDashboard.php" data-toggle="tooltip" title="Home" class="red-tooltip" data-placement="left"><i class="fa fa-home"></i> Dashboard </a>/ Manage Blogs</h3>
                </div>
                <div class="col-lg-3">
                  <h3 id="show_time" style="text-align: center;"></h3>
                </div>
                <div class="col-lg-5">
                  <h3 style="float: right;"><span id="greetings"></span>&nbsp &nbsp <?php echo $row["Fullname"]; ?> </h3>
                ...
                <div class="row">
                  <div class="col-lg-12"><?php
                    ...
                    <div class="quoteComponent">
                      <div class="well">
                        <div class="row">
                          <div class="col-lg-6">
                            <h5><b>Quote Id : </b> <?php echo $row["quote_id"]; ?></h5>
                          </div>
                          <div class="col-lg-6">
                            <h5 style="float: right;"><b>Date : </b><?php echo $row["sender_time"]; ?></h5>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-3">
                            <h5><b>Name : </b><?php echo $row["sender_names"]; ?></h5>                     
                          </div>
                          <div class="col-lg-4">
                            <h5><b>Email : </b><?php echo $row["sender_email"]; ?></h5>
                          </div>
                          <div class="col-lg-3">
                            <h5><b>Phone :</b> <?php echo $row["sender_phone"]; ?></h5>
                          </div>
                          <div class="col-lg-2">
                            <h5><b>Frieght Weight : </b><?php echo $row["sender_weight"]; ?></h5>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-3">
                            <h5><b>Pick Up Place : </b><?php echo $row["sender_fstate"]; ?></h5>
                          </div>
                          <div class="col-lg-3">
                            <h5><b>Departure Place :</b> <?php echo $row["sender_tstate"]; ?></h5>
                          </div>
                          <div class="col-lg-1"></div>
                          <div class="col-lg-5">
                            <h5><b>Frieght Type : </b><?php echo $row["sender_freight_type"]; ?></h5>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-11">
                            <h5><b>Special Info. : </b><?php echo $row["sender_message"]; ?></h5>
                          </div>
                          <div class="col-lg-1" >
                            <a href="quote_report.php?delete=<?php echo $row['id'] ?>" onclick="return confirm('Are you sure to delete this record?')">
                  ...
                  <div class="col-lg-8"  >
                    <div class="pagination" >
                      ...
                      if($page>=2){
                      echo "<a style='border:none;' href='feedbackReport.php?page=".($page-1)."'>  <i class='fa fa-backward'></i> </a>";
                      }
                      
                      for ($i=1; $i<=$total_pages; $i++) {
                      if ($i == $page) {
                      $pagLink .= "<a class = 'active' href='feedbackReport.php?page="
                      .$i."'>".$i." </a>";
                      }
                      else  {
                      $pagLink .= "<a href='feedbackReport.php?page=".$i."'>
                      ".$i." </a>";
                      }
                      };
                      echo $pagLink;
                      ...
                      if($page<$total_pages){
                      echo "<a style='border:none;' href='feedbackReport.php?page=".($page+1)."'>  <i class='fa fa-forward'></i> </a>";
                      }
