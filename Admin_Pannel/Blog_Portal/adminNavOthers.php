...
<div class="navbar-header" >
  ...
  <span class="icon-bar" style="background-color: #2c37a0"></span>
  <span class="icon-bar" style="background-color: #2c37a0"></span>
  <span class="icon-bar" style="background-color: #2c37a0"></span>
  </button>
...
<div class="collapse navbar-collapse" id="myNavbar">
  <ul class="nav navbar-nav navbar-right" style="margin-top: 10px;">    
    <li><a href="index.php">Courier</a></li>
    <li><a href="quote_report.php">Quote Request</a></li>
    <li><a href="feedback_report.php">Feedback</a></li>
    <li><a href="blogs_report.php">Blog</a></li>
