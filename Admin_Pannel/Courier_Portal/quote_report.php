...
<!DOCTYPE html>
<html>
  <title>Quote Report - <?php echo $row["Fullname"]; ?></title>
    ...
    <div class="row">
      <div class="col-lg-2 hidden-xs">
        <div class="leftPannel">
          ...
          <?php include_once 'sideNavCourier.php' ?>
        </div>
            ...
            <div class="rightPaggignation" >
              <div class="row">
                <div class="col-lg-4 col-xs-12">
                  <h3><a href="../AdminDashboard.php" data-toggle="tooltip" title="Home" class="red-tooltip" data-placement="left"><i class="fa fa-home"></i> Dashboard </a>/ Quotes Report</h3>
                </div>
                <div class="timeName">
              ...
              <div class="reportDisplayComponent">
                ...
                <div class="row">
                  <div class="col-lg-12"><?php
                    ...
                    $query = "SELECT * FROM quote order by sender_time desc LIMIT $start_from, $per_page_record";
                    ...
                    <div class="quoteComponent">
                      <div class="well">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2">
                            <h5><b>Weight : </b><?php echo $row["sender_weight"]; ?> Kg</h5>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-3">
