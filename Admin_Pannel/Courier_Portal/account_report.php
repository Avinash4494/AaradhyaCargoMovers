...
<!DOCTYPE html>
<html>
  <title>Account Report - <?php echo $row["Fullname"]; ?></title>
        ...
        <div class="rightPannelProfile" >
          <div class="dashIntro" >
            <div class="rightPaggignation" >
              <div class="row">
                <div class="col-lg-7">
                  <h3><a href="../AdminDashboard.php" data-toggle="tooltip" title="Home" class="red-tooltip"><i class="fa fa-home"></i> Dashboard </a>/ Account Report</h3>
                </div>
                <div class="col-lg-5">
