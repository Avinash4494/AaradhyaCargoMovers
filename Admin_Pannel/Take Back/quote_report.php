...
<div style="display:none;" id="myDiv" class="animate-bottom"> 
 ...
 <div class="sectionHead">
        ...
        <div class="reportWell" class="container-fluid">
            <h2>Quote Report</h2>
            <h3>Details for Requested Quick Quote</h3>
    ...
    <tr>
      <h5><i class="fa fa-list-alt" style="color: #2C37A0;"></i></h5>
       ...
       <tbody>
        ...
        <tr>
          <td><h4>From</h4></td>
           <td><h4><?php echo $row["fstate"]; ?></h4></td>
        </tr>
         <tr>
          <td><h4>To</h4></td>
           <td><h4><?php echo $row["tstate"]; ?></h4></td>
        </tr>
        </tbody>
    </table>
    </div>
   ...
   <div class="col-lg-12">
     <div class="well" >
      <h5><i class="fa fa-list-alt" style="color: #2C37A0;"></i></h5>
           ...
           <h4><b>From :</b> <?php echo $row["fstate"]; ?></h4>
           <h4><b>To :</b> <?php echo $row["tstate"]; ?></h4>
