      ...
      <div class="row">
        ...
        <div class="col-lg-4" >
          <div class="animateComp">
            ...
            <h4><a href="index.php"> <i class="fa fa-home"></i> Home</a> / <span>Office Locations</span></h4>
          </div>
        </div>
      </div>
    </section>
                      ...
                      ?>
                        <div class="col-lg-6">
                          <div class="networkComp">
                            <div class="well">
                              <h4><?php echo $rowMember["net_offName"]; ?></h4>
                              <h5>(<?php echo $rowMember["net_townCity"]; ?>)</h5>
                              <h5 style="line-height: 25px;"><?php echo $rowMember["net_address"]; ?>,<?php echo $rowMember["net_State"]; ?>,<?php echo $rowMember["net_pin"]; ?></h5>
