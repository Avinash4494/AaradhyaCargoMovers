...
mysqli_query($connect,"insert into schedule_pickup(pickup_id,user_id,pick_date,pick_time,pick_address,pick_city,pick_pincode,pick_state,pick_phone,pick_deliAddress,pick_deliCity,pick_deliPincode,pick_deliState,pick_deliPhone,pick_personal_names,pick_personal_email,pick_personal_phone,gstin,company_address,pick_message,pick_freight_type,pick_status,update_by,follow_mode,status_msg,updated_on,pick_request_date) 

	values ('$pickup_id_gen','$user_id','$pick_date','$pick_time','$pick_address','$pick_city','$pick_pincode','$pick_state','$pick_phone','$pick_deliAddress','$pick_deliCity','$pick_deliPincode','$pick_deliState','$pick_deliPhone','$pick_personal_names','$pick_personal_email','$pick_personal_phone','$gstin','$company_address','$pick_message','$pick_freight_type','$pick_status','$status_msg','$update_by','$follow_mode','$updated_on','$pick_request_date')") or die(mysqli_error());
