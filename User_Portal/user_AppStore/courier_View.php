...
<html>
  <head>
    <title>Tax Invoice - <?php echo $rowMember["invoice_no"]; ?></title>
  </head>
  <body>
          ...
          <div class="col-lg-12">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../UserDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <span class="activePage">Invoice Download</span></h5>
              </div>
              <div class="widgetShipmentComp">
                <div class="well">
                  <div class="row">
                    ...
                    <div class="col-lg-1">
                       <button class="actionButtonCreate" style="margin-top: 8px;" onclick="printDivSection('print_setion')" type="submit" data-toggle="tooltip" title="Print" data-placement="top"><i class="fa fa-print"></i></button>
                    </div>
 
                  </div>
                   <!-- PRINT SECTION -->
 
              <div id="print_setion" style="border:2px solid black;padding: 5px; margin-bottom: 20px;margin-top: 10px;">
