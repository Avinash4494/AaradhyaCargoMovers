					...
					<div class="col-lg-10">
						<div class="rightPannel">
							<div class="paggignation">
								<h5><a href="../EmpDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="index.php" data-toggle="tooltip" title="Profile Portal!" data-placement="top">Profile Portal</a> / <span class="activePage">Fill Timesheet</span></h5>
							</div>
                    ...
                    <div class="col-lg-3">
                      <div class="claimSidePan" style="margin-top: -35px;">
                        ...
                        <div class="otherPannel">
                          <a href="../empAppStore/raise_feedback.php">
                            <div class="well">
                        ...
                        <div class="otherPannel">
                          <a href="../empAppStore/helpDesk.php">
                            <div class="well">
                              <h4>Help Desk</h4>
                            </div>
                          </a>
