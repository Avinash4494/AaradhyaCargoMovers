      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="paggignation">
            <h5><a href="../EmpDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> /<a href="myHelpline_index.php" data-toggle="tooltip" title="My Helpline!" data-placement="top">myHelpline</a> / <span class="activePage">Report an Incident</span></h5>
          </div>
        </div>
        <div class="col-lg-7">
          ...
          <div class="row">
            <div class="col-lg-10">
              <div class="bodyComponent">
                ...
                <p>Request assistance with an issue you are having. An incident record will be created and managed through to successful resolution.</p>
