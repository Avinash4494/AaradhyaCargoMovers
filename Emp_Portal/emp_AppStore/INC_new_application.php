    ...
    <div class="wrapper">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="paggignation">
                <h5><a href="../EmpDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> /<a href="myHelpline_index.php" data-toggle="tooltip" title="My Helpline!" data-placement="top">myHelpline</a> / <span class="activePage">Report Incident</span></h5>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="compPartPannel">
          <div class="well">
            <div class="row">
           <a href="INC_report_Infra_new.php">
                <div class="col-lg-4">
             ...
             <a href="INC_report_application_new">
                <div class="col-lg-4">
                <div class="compPartSubPannel">
