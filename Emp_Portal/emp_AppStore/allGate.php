              ...
              <table class="css-serial table table-hover" width="100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td ></td>
                    <td><b><a style="color: black;" href="view_gate.php?id=<?php echo $rowMember['id'] ?>" data-toggle="tooltip" title="View" data-placement="left"><?php echo $rowMember['request_id'] ?></a></b></td>
