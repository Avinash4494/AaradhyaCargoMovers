            ...
            <div class="leftPannel">
              ...
              <div class="mainHeadDesc">
               <div class="well">
                  <div class="row">
                  <div class="col-lg-3">
                    <img src="../image/help.png" alt="" class="img-responsive">
                  </div>
                  <div class="col-lg-9">
                    <h4>Help Desk</h4>
                  </div>
          ...
          <div class="col-lg-6">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../EmpDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <span class="activePage">Helpdesk</span></h5>
              </div>
