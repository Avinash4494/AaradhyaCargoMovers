          ...
          <div class="col-lg-10">
            <div class="rightPannel">
              <div class="paggignation">
               <h5><a href="../EmpDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="claims_index.php" data-toggle="tooltip" title="My Claims!" data-placement="top">My Claims</a> / <span class="activePage">Medi Claim Details</span></h5>
              </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-8">
                            ...
                            ?>
                                ...
                                if ($status==$active) {
                                ?>
                                <h5>Your Medi claim request is active since <?php echo $days; ?> days and waiting for approval.</h5>
                                <?php
                                }
                                else if($status == $pending)
                                {
                                ?>
                                <h5>Your Medi claim request is pending since <?php echo $days; ?> days and waiting for approval.</h5>
                                <?php
                                }
                                else if($status == $approved)
                                {
                                ?>
                                <h5>Your Medi claim request is approved.</h5>
                                <?php
                                }
                                else if($status==$Rejected)
                                {
                                ?>
                                <h5>Your Medi claim request is rejected.</h5>
                                <?php
                                }
                                ?>
                            <div class="row">
                              <div class="col-lg-4">
                                ...
                                <p>Raised By - <?php echo $rowClaim['raised_by'] ?></p>
                                 <p>Claim Type :  <?php echo $rowClaim['claimCategory'] ?></p>
                              </div>
                              <div class="col-lg-4">
                              ...
                              <p>Illness Type :  <?php echo $rowClaim['illnessCategory'] ?></p>
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-6">
                                <img src="<?php echo $upload_dir.$rowClaim['medi_image'] ?>" class="img-responsive">
                              </div>
