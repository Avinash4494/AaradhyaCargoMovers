...
echo '<script>
setTimeout(function(){ window.location.href="allByod.php"; }, 1000);
</script>';
}
}
}
          ...
          <div class="col-lg-10">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../EmpDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="request_index.php" data-toggle="tooltip" title=" My Request!" data-placement="top">My Request</a> / <span class="activePage">Conveyance Claim Summary</span></h5>
              </div>
              <div id="print_setion">
              ...
              <table class="css-serial table table-hover" width="100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td ></td>
                    <td><b><a style="color: black;" href="view_convclaims.php?id=<?php echo $rowMember['id'] ?>" data-toggle="tooltip" title="View" data-placement="left"><?php echo $rowMember['claim_id'] ?></a></b></td>
                  ...
                  <div class="row" >
                    <div class="col-lg-8 col-xs-12"  >
                      <div class="pagination" >
                        ...
                        $pagLink = "";
                        if($page>=2){
                        echo "<a style='border:none;' href='allConvClaims.php?page=".($page-1)."'>  <i class='fa fa-backward'></i> </a>";
                        }
                        for ($i=1; $i<=$total_pages; $i++) {
                        if ($i == $page) {
                        $pagLink .= "<a class = 'active' href='allConvClaims.php?page="
                        .$i."'>".$i." </a>";
                        }
                        else  {
                        $pagLink .= "<a href='allConvClaims.php?page=".$i."'>
                        ".$i." </a>";
                        }
                        };
                        echo $pagLink;
                        if($page<$total_pages){
                        echo "<a style='border:none;' href='allConvClaims.php?page=".($page+1)."'>  <i class='fa fa-forward'></i> </a>";
                        }
                        ?>
                      </div>
                    </div>
