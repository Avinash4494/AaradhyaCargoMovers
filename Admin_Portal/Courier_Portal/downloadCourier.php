...
<!DOCTYPE html>
<html>
  <title>ACM <?php echo $rowMember['invoice_no'] ?>  </title>
  <head>
  </head>
          ...
          <div class="col-lg-10">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="courier_index.php" data-toggle="tooltip" title="Couriers Portal!" data-placement="top">Couriers Portal</a> / <span class="activePage">Download Invoice</span></h5>
              </div>
 
               <div class="rectLongContent hidden-lg" style="margin-top: -20px;margin-bottom: 30px;">
                        <div class="rectWidge" >
                         
                           <h5 style="text-align: center;font-weight: bold;">Docket Number : <?php echo $rowMember['docketNumber'] ?></h5>
              ...
              <div id="print_setion" class="hidden" style="border:2px solid black;padding: 5px; margin-bottom: 20px;margin-top: -15px;">
