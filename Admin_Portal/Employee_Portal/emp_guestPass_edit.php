                    ...
                    <div class="profileDisplayComponent">
                      <div class="well">
                        ...
                        <div id="ConvDetails" >
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <h5>Guest Name: <?php echo $rowEdit['guest_name'] ?></h5>
                        ...
                        <div class="formPannel">
                          <form class="" name ="register" onsubmit="return myvalidate();" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-3 col-xs-12">
                                <div class="form-group">
                                  <label for="">Pass Type<span>*</span></label>
                                  <input type="text" id="total_claimed" name="pass_type" class="form-control"
                                  value="<?php echo $rowEdit['pass_type']?>"  >
                                </div>
                              </div>
                              <div class="col-lg-3 col-xs-12">
                                <div class="form-group">
