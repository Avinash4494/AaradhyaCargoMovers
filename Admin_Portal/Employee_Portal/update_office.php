                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                           <h6 style="float: right;">Your Information was last updated on : <?php echo $rowMember['offc_upDate'] ?></h6>
                        </div>
                      </div>
                                  ...
                                  <div class="row">
                                    <div class="col-lg-4 col-xs-12">
                                      <div class="form-group">
                                        ...
                                        <input type="text" id="dob" name="employees_id" class="form-control" value="<?php echo $rowMember['employees_id']?>" disabled>
                                      </div>
                                    </div>
                                    <div class="col-lg-4 col-xs-12">
                                      <div class="form-group">
                                        <label for="">Designation <span>*</span></label>
                                        <input type="text" id="dob" name="offc_desig" placeholder="Designation" class="form-control" value="<?php echo $rowMember['offc_desig']?>">
                                      </div>
                                    </div>
                                    <div class="col-lg-4 col-xs-12">
                                      <div class="form-group">
                                        <label for="">Floor<span>*</span></label>
                                        <select name="offc_floor" class="form-control" id="">
                                  ...
                                  <div class="row">
                                    <div class="col-lg-3 col-xs-12">
                                      <div class="form-group">
                                        ...
                                        <select name="offc_wing" class="form-control" id="">
                                          <option value="Select Any">Select Any</option>
                                    ...
                                    <div class="col-lg-3 col-xs-12">
                                      <div class="form-group">
                                        ...
                                        <input type="text" id="" name="offc_cubicle" class="form-control" placeholder ="Office Cubicle" value="<?php echo $rowMember['offc_cubicle']?>">
                                      </div>
                                    </div>
                                    <div class="col-lg-3 col-xs-12">
                                      <div class="form-group">
                                        <label for="">Tower Number<span>*</span></label>
                                        <input type="text" id="" name="offc_tower" class="form-control" placeholder ="Office Tower" value="<?php echo $rowMember['offc_tower']?>">
                                      </div>
                                    </div>
                                     <div class="col-lg-3 col-xs-12">
                                      <div class="form-group">
                                        <label for="">Office Location <span>*</span></label>
                                        <select name="offc_location" class="form-control" id="">
                                          <option value="Select Any">Select Any</option>
                                          <option value="ACM-Banglore">ACM-Banglore</option>
                                          <option value="ACM-Delhi">ACM-Delhi</option>
                                          <option value="ACM-Uttar Pradesh">ACM-Uttar Pradesh</option>
                                        </select>
                                      </div>
                                    </div>
                                  </div>
