          ...
          <div class="col-lg-10">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="emp_index.php" data-toggle="tooltip" title="Employees Portal!" data-placement="top" >Employees Portal</a> / <span class="activePage"> Medi Claim Summary </span> </h5>
              </div>
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="row" >
                            <div class="col-lg-8 col-xs-12"  >
                              <div class="pagination" >
                                ...
                                $pagLink = "";
                                if($page>=2){
                                echo "<a style='border:none;' href='all_medi_list.php?page=".($page-1)."'>  <i class='fa fa-backward'></i> </a>";
                                }
                                for ($i=1; $i<=$total_pages; $i++) {
                                if ($i == $page) {
                                $pagLink .= "<a class = 'active' href='all_medi_list.php?page="
                                .$i."'>".$i." </a>";
                                }
                                else  {
                                $pagLink .= "<a href='all_medi_list.php?page=".$i."'>
                                ".$i." </a>";
                                }
                                };
                                echo $pagLink;
                                if($page<$total_pages){
                                echo "<a style='border:none;' href='all_medi_list.php?page=".($page+1)."'>  <i class='fa fa-forward'></i> </a>";
                                }
                                ?>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              ...
                              $q = "SELECT * FROM raise_mediclaim where (claim_id = '$dock_num')";
                                  ...
                                  <div id="ConvDetails" >
                                    ...
                                    <div class="row">
                                      <div class="col-lg-3">
                                        ...
                                        <h5>Claim Type :  <?php echo $rowSearch['claimCategory'] ?></h5>
                                        <h5>Illness Type :  <?php echo $rowSearch['illnessCategory'] ?></h5>
                                      </div>
                                      <div class="col-lg-3">
                                      ...
                                      <div class="col-lg-3">
                                        <div class="fullImage">
                                          ...
                                          <a href="<?php echo $upload_dir.$rowSearch['medi_image'] ?>" target="blank">
                                            <?php echo $rowSearch['medi_image'] ?>
                                          </a>
                                        </div>
                                      </div>
                                    </div>
