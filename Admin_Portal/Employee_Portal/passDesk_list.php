          ...
          <div class="col-lg-10">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="emp_index.php" data-toggle="tooltip" title="Employees Portal!" data-placement="top" >Employees Portal</a> / <span class="activePage">Desktop Request Summary </span> </h5>
              </div>
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="row" >
                            <div class="col-lg-8 col-xs-12"  >
                              <div class="pagination" >
                                ...
                                $pagLink = "";
                                if($page>=2){
                                echo "<a style='border:none;' href='passDesk_list.php?page=".($page-1)."'>  <i class='fa fa-backward'></i> </a>";
                                }
                                for ($i=1; $i<=$total_pages; $i++) {
                                if ($i == $page) {
                                $pagLink .= "<a class = 'active' href='passDesk_list.php?page="
                                .$i."'>".$i." </a>";
                                }
                                else  {
                                $pagLink .= "<a href='passDesk_list.php?page=".$i."'>
                                ".$i." </a>";
                                }
                                };
                                echo $pagLink;
                                if($page<$total_pages){
                                echo "<a style='border:none;' href='passDesk_list.php?page=".($page+1)."'>  <i class='fa fa-forward'></i> </a>";
                                }
                                ?>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              ...
                              $q = "SELECT * FROM raise_desktop where (request_id = '$dock_num')";
                                ...
                                <div class="well">
                                  <div id="ConvDetails" >
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-4">
                                        <h5>State : <?php echo $rowSearch['state'] ?></h5>
                                        <h5>City : <?php echo $rowSearch['city'] ?></h5>
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="col-lg-4">
                                        <h5>Company code: <?php echo $rowSearch['com_code'] ?></h5>
                                        <h5>Cubicle : <?php echo $rowSearch['cubicle'] ?></h5>
                                      </div>
                                      <div class="col-lg-4">
                                        <h5>Wing : <?php echo $rowSearch['wing'] ?></h5>
                                        <h5>Floor : <?php echo $rowSearch['floor_num'] ?></h5>
                                      </div>
                                      <div class="col-lg-4">
