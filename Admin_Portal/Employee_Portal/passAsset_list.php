          ...
          <div class="col-lg-10">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="emp_index.php" data-toggle="tooltip" title="Employees Portal!" data-placement="top" >Employees Portal</a> / <span class="activePage">Asset Request Summary </span> </h5>
              </div>
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="row" >
                            <div class="col-lg-8 col-xs-12"  >
                              <div class="pagination" >
                                <?php
                                $query = "SELECT COUNT(*) FROM raise_asset";
                                $rs_result = mysqli_query($connect, $query);
                                ...
                                $pagLink = "";
                                if($page>=2){
                                echo "<a style='border:none;' href='passAsset_list.php?page=".($page-1)."'>  <i class='fa fa-backward'></i> </a>";
                                }
                                for ($i=1; $i<=$total_pages; $i++) {
                                if ($i == $page) {
                                $pagLink .= "<a class = 'active' href='passAsset_list.php?page="
                                .$i."'>".$i." </a>";
                                }
                                else  {
                                $pagLink .= "<a href='passAsset_list.php?page=".$i."'>
                                ".$i." </a>";
                                }
                                };
                                echo $pagLink;
                                if($page<$total_pages){
                                echo "<a style='border:none;' href='passAsset_list.php?page=".($page+1)."'>  <i class='fa fa-forward'></i> </a>";
                                }
                                ?>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              ...
                              $q = "SELECT * FROM raise_asset where (request_id = '$dock_num')";
                                ...
                                <div class="well">
                                  <div id="ConvDetails" >
                                    <div class="row">
                                      ...
                                      <div class="col-lg-2">
                                        <div class="actionButtonRequest" style="padding: 8px 0px;"><h4 style="color: #1c2833;padding-top: 20px;"><?php echo $rowEdit['req_status'] ?></h4></div>
                                      </div>
                                    </div> <hr/>
                                    <h4>Asset Summary</h4>
                                    <div class="row">
