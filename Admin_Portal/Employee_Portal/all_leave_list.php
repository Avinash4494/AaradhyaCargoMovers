                              ...
                              <div class="row" >
                                <div class="col-lg-8 col-xs-12"  >
                                  <div class="pagination" >
                                    ...
                                    $pagLink = "";
                                    if($page>=2){
                                    echo "<a style='border:none;' href='all_leave_list.php?page=".($page-1)."'>  <i class='fa fa-backward'></i> </a>";
                                    }
                                    for ($i=1; $i<=$total_pages; $i++) {
                                    if ($i == $page) {
                                    $pagLink .= "<a class = 'active' href='all_leave_list.php?page="
                                    .$i."'>".$i." </a>";
                                    }
                                    else  {
                                    $pagLink .= "<a href='all_leave_list.php?page=".$i."'>
                                    ".$i." </a>";
                                    }
                                    };
                                    echo $pagLink;
                                    if($page<$total_pages){
                                    echo "<a style='border:none;' href='all_leave_list.php?page=".($page+1)."'>  <i class='fa fa-forward'></i> </a>";
                                    }
                                    ?>
                                  </div>
                                </div>
