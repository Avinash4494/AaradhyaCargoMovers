          ...
          <div class="col-lg-10">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="emp_index.php" data-toggle="tooltip" title="Employees Portal!" data-placement="top" >Employees Portal</a> / <span class="activePage"> Leave Summary </span> </h5>
              </div>
                        ...
                        <div class="row">
                          <div class="col-lg-8">
                            <div class="form-group">
                              <input type="text" class="form-control" style="margin-left: 30px;" id="word"  name="leave_id"  autocomplete="off" placeholder="Enter Leave ID"  required>
                            </div>
                          </div>
                          <div class="col-lg-4">
                        ...
                        <div id="allLeaves" class="tab-pane fade in active ">
                          <div class="row">
                              ...
                              <div class="row" >
                                <div class="col-lg-8 col-xs-12"  >
                                  <div class="pagination" >
                                    <?php
                                    $query = "SELECT COUNT(*) FROM apply_leave";
                                    $rs_result = mysqli_query($connect, $query);
                                    ...
                                    $pagLink = "";
                                    if($page>=2){
                                    echo "<a style='border:none;' href='employee_leave_View.php?page=".($page-1)."'>  <i class='fa fa-backward'></i> </a>";
                                    }
                                    for ($i=1; $i<=$total_pages; $i++) {
                                    if ($i == $page) {
                                    $pagLink .= "<a class = 'active' href='employee_leave_View.php?page="
                                    .$i."'>".$i." </a>";
                                    }
                                    else  {
                                    $pagLink .= "<a href='employee_leave_View.php?page=".$i."'>
                                    ".$i." </a>";
                                    }
                                    };
                                    echo $pagLink;
                                    if($page<$total_pages){
                                    echo "<a style='border:none;' href='employee_leave_View.php?page=".($page+1)."'>  <i class='fa fa-forward'></i> </a>";
                                    }
                                    ?>
                                  </div>
                                </div>
                            ...
                            <div class="col-lg-12">
                                  ...
                                  $dock_num = $_POST['leave_id'];
                                  $q = "SELECT * FROM apply_leave where (leave_id = '$dock_num')";
                                  ...
                                  <div class="profileDisplayComponent" style="margin-top: 20px;">
                                    <div class="well">
                                      <div class="row">
                                        <div class="col-lg-10">
                                          <h5>Leave Summary (<?php echo $rowSearch['leave_id'] ?>)</h5>
                                        </div>
                                        <div class="col-lg-2">
                                          <div class="actionButtonRequest" style="margin-top: 10px;padding: 8px 0px;"><h5 style="color: #1c2833;text-align: center;"><?php echo $rowSearch['status'] ?></h5></div>
                                        </div>
                                      </div>
                                      <div id="ConvDetails" >
                                        <div class="row">
                                          <div class="col-lg-4">
                                            ...
                                            <h5>Raised On: <?php echo $rowSearch['appliedDate'] ?></h5>
                                          </div>
                                          <div class="col-lg-4">
                                            <h5>Leave From : <?php echo $rowSearch['leaveFrom'] ?></h5>
                                            <h5>Leave To : <?php echo $rowSearch['leaveTo'] ?></h5>
                                          </div>
                                          <div class="col-lg-4">
                                            <h5>No. Of Days : <?php echo $rowSearch['noOfDays'] ?></h5>
                                            <h5>Leave Type : <?php echo $rowSearch['leaveType'] ?></h5>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
