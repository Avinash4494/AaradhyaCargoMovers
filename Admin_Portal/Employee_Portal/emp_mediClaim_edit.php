            ...
            <div class="col-lg-10">
              <div class="rightPannel">
                <div class="paggignation">
                  <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="emp_index.php" data-toggle="tooltip" title="Employees Portal!" data-placement="top">Employees Portal</a> / <span class="activePage">Medi Claim Request</span></h5>
                </div>
                <div id="print_setion">
                  <div class="bodyComponent">
                    <div class="profileDisplayComponent">
                      <div class="well">
                           <div class="row">
                          <div class="col-lg-10">
                             <h4>Medi Claim Details (<?php echo $rowEdit['claim_id'] ?>)</h4>
                          </div>
                          <div class="col-lg-2">
                        ...
                        <div id="ConvDetails" >
                          <div class="row">
                            <div class="col-lg-3">
                              ...
                              <h5>Claim Type :  <?php echo $rowEdit['claimCategory'] ?></h5>
                              <h5>Illness Type :  <?php echo $rowEdit['illnessCategory'] ?></h5>
                            </div>
                            <div class="col-lg-3">
                              <h5>Claimed Amount : <i class="fa fa-inr"></i> <?php echo $rowEdit['claim_amount'] ?>.00</h5>
                              <h5>Total Amount : <i class="fa fa-inr"></i>  <?php echo $rowEdit['total_claimed'] ?>.00</h5>
                            </div>
                            <div class="col-lg-3">
                              <h5>Raised On: <?php echo $rowEdit['raised_on'] ?></h5>
                              <h5>Bill Date : <?php echo $rowEdit['bill_date'] ?></h5>
                            </div>
                            <div class="col-lg-3">
                              <div class="fullImage">
                                <h5>Supporing Document &nbsp <i class="fa fa-download"></i></h5>
                                <a href="<?php echo $upload_dir.$rowEdit['medi_image'] ?>" target="blank">
                                  <?php echo $rowEdit['medi_image'] ?>
                                </a>
                              </div>
                            </div>
                          </div>
