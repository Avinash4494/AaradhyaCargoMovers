            ...
            <div class="col-lg-10">
              <div class="rightPannel">
                <div class="paggignation">
                  <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="emp_index.php" data-toggle="tooltip" title="Employees Portal!" data-placement="top">Employees Portal</a> / <span class="activePage">Miscellaneous Claim Request</span></h5>
                </div>
                <div id="print_setion">
                  <div class="bodyComponent">
                    <div class="profileDisplayComponent">
                      <div class="well">
                         <div class="row">
                          <div class="col-lg-10">
                             <h4>Miscellaneous Claim Details (<?php echo $rowEdit['claim_id'] ?>)</h4>
                          </div>
                          <div class="col-lg-2">
                        ...
                        <div id="ConvDetails" >
                          <div class="row">
                            <div class="col-lg-3">
                              ...
                              <h5>Category :  <?php echo $rowEdit['misceCategory'] ?></h5>
                            </div>
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-3">
                              <div class="fullImage">
                                ...
                                <a href="<?php echo $upload_dir.$rowEdit['misce_image'] ?>" target="blank">
                                  <?php echo $rowEdit['misce_image'] ?>
                                </a>
                              </div>
                            </div>
                          </div>
