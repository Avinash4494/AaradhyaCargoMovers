                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="row" >
                            <div class="col-lg-8 col-xs-12"  >
                              <div class="pagination" >
                                <?php
                                $query = "SELECT COUNT(*) FROM raise_business_card";
                                $rs_result = mysqli_query($connect, $query);
                                ...
                                $pagLink = "";
                                if($page>=2){
                                echo "<a style='border:none;' href='passBuis_list.php?page=".($page-1)."'>  <i class='fa fa-backward'></i> </a>";
                                }
                                for ($i=1; $i<=$total_pages; $i++) {
                                if ($i == $page) {
                                $pagLink .= "<a class = 'active' href='passBuis_list.php?page="
                                .$i."'>".$i." </a>";
                                }
                                else  {
                                $pagLink .= "<a href='passBuis_list.php?page=".$i."'>
                                ".$i." </a>";
                                }
                                };
                                echo $pagLink;
                                if($page<$total_pages){
                                echo "<a style='border:none;' href='passBuis_list.php?page=".($page+1)."'>  <i class='fa fa-forward'></i> </a>";
                                }
                                ?>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              ...
                              $q = "SELECT * FROM raise_business_card where (request_id = '$dock_num')";
                                ...
                                <div class="well">
                                  <div id="ConvDetails" >
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-4">
                                        <h5>Name on Card : <?php echo $rowSearch['name'] ?></h5>
                                        <h5>Designation : <?php echo $rowSearch['designation'] ?></h5>
                                      </div>
                                      <div class="col-lg-4">
                                        <h5>No. Of Cards : <?php echo $rowSearch['noOfCards'] ?></h5>
                                        <h5>Location : <?php echo $rowSearch['offc_location'] ?></h5>
                                      </div>
                                    </div>
