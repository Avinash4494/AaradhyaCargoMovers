                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          <table class="css-serial table table-hover" width="100%">
                            ...
                            margin-top: -25px; /* Set the serial number counter to 0 */
                            }
                          ...
                          <div class="row" >
                            <div class="col-lg-8 col-xs-12"  >
                              <div class="pagination" >
                                ...
                                $pagLink = "";
                                if($page>=2){
                                echo "<a style='border:none;' href='all_food_list.php?page=".($page-1)."'>  <i class='fa fa-backward'></i> </a>";
                                }
                                for ($i=1; $i<=$total_pages; $i++) {
                                if ($i == $page) {
                                $pagLink .= "<a class = 'active' href='all_food_list.php?page="
                                .$i."'>".$i." </a>";
                                }
                                else  {
                                $pagLink .= "<a href='all_food_list.php?page=".$i."'>
                                ".$i." </a>";
                                }
                                };
                                echo $pagLink;
                                if($page<$total_pages){
                                echo "<a style='border:none;' href='all_food_list.php?page=".($page+1)."'>  <i class='fa fa-forward'></i> </a>";
                                }
                                ?>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              ...
                              $q = "SELECT * FROM raise_foodclaim where (claim_id = '$dock_num')";
                                  ...
                                  <div id="ConvDetails" >
                                    ...
                                    <div class="row">
                                      <div class="col-lg-3">
                                        ...
                                        <h5>Category :  <?php echo $rowSearch['foodCategory'] ?></h5>
                                        <h5>No. Of Person :  <?php echo $rowSearch['noOfPeople'] ?></h5>
                                      </div>
                                      <div class="col-lg-3">
                                      ...
                                      <div class="col-lg-3">
                                        <div class="fullImage">
                                          ...
                                          <a href="<?php echo $upload_dir.$rowSearch['food_image'] ?>" target="blank">
                                            <?php echo $rowSearch['food_image'] ?>
                                          </a>
                                        </div>
                                      </div>
                                    </div>
