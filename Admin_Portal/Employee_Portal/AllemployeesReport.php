					...
					<div class="col-lg-10">
						<div class="rightPannel">
							<div class="paggignation">
								<h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="emp_index.php" data-toggle="tooltip" title="Employees Portal!" data-placement="top">Employees Portal</a> / <span class="activePage">Employees Reports</span></h5>
							</div>
							<div class="row">
									...
									<div class="col-lg-12">
										<table class="tablePrint" border="0" width="100%">
											<tbody>
												<tr>
													<td>
														<h4 style="text-align: center;padding-top: 15px;">Employees Report</h4>
													</td>
												</tr>
											</tbody>
										</table>
