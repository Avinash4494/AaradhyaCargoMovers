          ...
          <div class="col-lg-10">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="emp_index.php" data-toggle="tooltip" title="Employees Portal!" data-placement="top" >Employees Portal</a> / <span class="activePage"> Gate Pass Summary </span> </h5>
              </div>
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="row" >
                            <div class="col-lg-8 col-xs-12"  >
                              <div class="pagination" >
                                <?php
                                $query = "SELECT COUNT(*) FROM raise_gate_pass";
                                $rs_result = mysqli_query($connect, $query);
                                ...
                                $pagLink = "";
                                if($page>=2){
                                echo "<a style='border:none;' href='passGate_list.php?page=".($page-1)."'>  <i class='fa fa-backward'></i> </a>";
                                }
                                for ($i=1; $i<=$total_pages; $i++) {
                                if ($i == $page) {
                                $pagLink .= "<a class = 'active' href='passGate_list.php?page="
                                .$i."'>".$i." </a>";
                                }
                                else  {
                                $pagLink .= "<a href='passGate_list.php?page=".$i."'>
                                ".$i." </a>";
                                }
                                };
                                echo $pagLink;
                                if($page<$total_pages){
                                echo "<a style='border:none;' href='passGate_list.php?page=".($page+1)."'>  <i class='fa fa-forward'></i> </a>";
                                }
                                ?>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              ...
                              $q = "SELECT * FROM raise_gate_pass where (request_id = '$dock_num')";
                                ...
                                <div class="well">
                                  <div id="ConvDetails" >
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-4">
                                        <h5>Move Between : <?php echo $rowSearch['move_btwn'] ?></h5>
                                        <h5>Material Type : <?php echo $rowSearch['mat_type'] ?></h5>
                                        <h5>Quantity : <?php echo $rowSearch['quantity'] ?> Nos</h5>
                                      </div>
                                      <div class="col-lg-4">
                                        <h5>Carried Out Date : <?php echo $rowSearch['out_date'] ?></h5>
                                        <h5>Carried Out By : <?php echo $rowSearch['out_by'] ?></h5>
                                        <h5>Weight : <?php echo $rowSearch['total_weight'] ?></h5>
                                      </div>
                                      
                                    </div>
                                    <div class="row">
                                      <div class="col-lg-12">
                                        <h5>Material Description : <?php echo $rowSearch['mat_descp'] ?></h5>
                                      </div>
                                    </div>
                                    <hr/>
                                    ...
                                    <div class="row">
                                      <div class="col-lg-4">
                                        <h5>Guest Name: <?php echo $rowSearch['sender_name'] ?></h5>
                                      ...
                                      <div class="col-lg-4">
                                        <h5>Location : <?php echo $rowSearch['sender_location'] ?></h5>
