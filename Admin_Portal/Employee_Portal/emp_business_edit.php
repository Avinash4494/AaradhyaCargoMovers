...
if(!isset($errorMsg)){
$sql = "update raise_business_card
                      ...
                      <div class="well">
                        ...
                        <div id="ConvDetails" >
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              <h5>Name on Card : <?php echo $rowEdit['name'] ?></h5>
                              <h5>Designation : <?php echo $rowEdit['designation'] ?></h5>
                            </div>
                            <div class="col-lg-4">
                              <h5>No. Of Cards : <?php echo $rowEdit['noOfCards'] ?></h5>
                              <h5>Location : <?php echo $rowEdit['offc_location'] ?></h5>
                            </div>
                          </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-3 col-xs-12">
                                <div class="form-group">
                                  ...
                                  value="<?php echo $rowEdit['designation']?>"  >
                                </div>
                              </div>
                              <div class="col-lg-3 col-xs-12">
                                <div class="form-group">
