                        ...
                        <div id="ConvDetails" >
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              ...
                              <h5>Pass Type: <?php echo $rowEdit['pass_type'] ?></h5>
                            </div>
                            <div class="col-lg-4">
                              <h5>Move Between : <?php echo $rowEdit['move_btwn'] ?></h5>
                              <h5>Material Type : <?php echo $rowEdit['mat_type'] ?></h5>
                              <h5>Quantity : <?php echo $rowEdit['quantity'] ?> Nos</h5>
                            </div>
                            <div class="col-lg-4">
                              <h5>Carried Out Date : <?php echo $rowEdit['out_date'] ?></h5>
                              <h5>Carried Out By : <?php echo $rowEdit['out_by'] ?></h5>
                              <h5>Weight : <?php echo $rowEdit['total_weight'] ?></h5>
                            </div>
                            
                          </div>
                          <div class="row">
                            <div class="col-lg-12">
                              <h5>Material Description : <?php echo $rowEdit['mat_descp'] ?></h5>
                            </div>
                        </div>
                          <hr/>
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <h5>Guest Name: <?php echo $rowEdit['sender_name'] ?></h5>
                              <h5>Organization : <?php echo $rowEdit['organisation'] ?></h5>
                            </div>
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                              <h5>Location : <?php echo $rowEdit['sender_location'] ?></h5>
                        ...
                        <div class="formPannel">
                          <form class="" name ="register" onsubmit="return myvalidate();" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-3 col-xs-12">
                                <div class="form-group">
                                  <label for="">Move Between<span>*</span></label>
                                  <input type="text" id="move_btwn" name="move_btwn" class="form-control"
                                  value="<?php echo $rowEdit['move_btwn']?>"  >
                                </div>
                              </div>
                              <div class="col-lg-3 col-xs-12">
                                <div class="form-group">
