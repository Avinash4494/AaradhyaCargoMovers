          ...
          <div class="col-lg-10">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="emp_index.php" data-toggle="tooltip" title="Employees Portal!" data-placement="top" >Employees Portal</a> / <span class="activePage"> Vehicle Pass Summary </span> </h5>
              </div>
     ...
     <div class="row" >
                                <div class="col-lg-8 col-xs-12"  >
                                  <div class="pagination" >
                                    <?php
                                    $query = "SELECT COUNT(*) FROM raise_vehicle_pass";
                                    $rs_result = mysqli_query($connect, $query);
                                    ...
                                    $pagLink = "";
                                    if($page>=2){
                                    echo "<a style='border:none;' href='passVech_list.php?page=".($page-1)."'>  <i class='fa fa-backward'></i> </a>";
                                    }
                                    for ($i=1; $i<=$total_pages; $i++) {
                                    if ($i == $page) {
                                    $pagLink .= "<a class = 'active' href='passVech_list.php?page="
                                    .$i."'>".$i." </a>";
                                    }
                                    else  {
                                    $pagLink .= "<a href='passVech_list.php?page=".$i."'>
                                    ".$i." </a>";
                                    }
                                    };
                                    echo $pagLink;
                                    if($page<$total_pages){
                                    echo "<a style='border:none;' href='passVech_list.php?page=".($page+1)."'>  <i class='fa fa-forward'></i> </a>";
                                    }
                                    ?>
                                  </div>
                                </div>
                              ...
                              <div class="row">
                                <div class="col-lg-12">
                                  ...
                                  $q = "SELECT * FROM raise_vehicle_pass where (request_id = '$dock_num')";
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-3">
                              <h5>Vehicle Number : <?php echo $rowSearch['veh_num'] ?></h5>
                              <h5>Vehicle Type : <?php echo $rowSearch['veh_type'] ?></h5>
                            </div>
                            <div class="col-lg-3">
                              <h5>Vehicle Name : <?php echo $rowSearch['veh_name'] ?></h5>
                              <h5>Vehicle Model : <?php echo $rowSearch['veh_model'] ?></h5>
                            </div>
                            <div class="col-lg-3">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-lg-4">
                              <h5>Location: <?php echo $rowSearch['veh_location'] ?></h5>
                              <h5>Ofiice Location : <?php echo $rowSearch['location'] ?></h5>
                            </div>
                            <div class="col-lg-4">
                              <h5>Comments : <?php echo $rowSearch['comments'] ?></h5>
                            </div>
                            <div class="col-lg-4">
