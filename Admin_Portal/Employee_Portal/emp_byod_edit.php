                      ...
                      <div class="well">
                        ...
                        <div id="ConvDetails" >
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              <h5>From Date : <?php echo $rowEdit['fromDate'] ?></h5>
                              <h5>To Date : <?php echo $rowEdit['toDate'] ?></h5>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-lg-4">
                              <h5>Device Type: <?php echo $rowEdit['dev_type'] ?></h5>
                              <h5>Device Name : <?php echo $rowEdit['dev_name'] ?></h5>
                            </div>
                            <div class="col-lg-4">
                              <h5>Model Number : <?php echo $rowEdit['dev_modelNo'] ?></h5>
                        ...
                        <div class="formPannel">
                          <form class="" name ="register" onsubmit="return myvalidate();" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-3 col-xs-12">
                                <div class="form-group">
                                  <label for="">Device Type<span>*</span></label>
                                  <input type="text" id="total_claimed" name="dev_type" class="form-control"
                                  value="<?php echo $rowEdit['dev_type']?>"  >
                                </div>
                              </div>
                              <div class="col-lg-3 col-xs-12">
                                <div class="form-group">
