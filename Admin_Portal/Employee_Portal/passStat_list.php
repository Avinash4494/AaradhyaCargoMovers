                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="row" >
                            <div class="col-lg-8 col-xs-12"  >
                              <div class="pagination" >
                                <?php
                                $query = "SELECT COUNT(*) FROM raise_stat";
                                $rs_result = mysqli_query($connect, $query);
                                ...
                                $pagLink = "";
                                if($page>=2){
                                echo "<a style='border:none;' href='passStat_list.php?page=".($page-1)."'>  <i class='fa fa-backward'></i> </a>";
                                }
                                for ($i=1; $i<=$total_pages; $i++) {
                                if ($i == $page) {
                                $pagLink .= "<a class = 'active' href='passStat_list.php?page="
                                .$i."'>".$i." </a>";
                                }
                                else  {
                                $pagLink .= "<a href='passStat_list.php?page=".$i."'>
                                ".$i." </a>";
                                }
                                };
                                echo $pagLink;
                                if($page<$total_pages){
                                echo "<a style='border:none;' href='passStat_list.php?page=".($page+1)."'>  <i class='fa fa-forward'></i> </a>";
                                }
                                ?>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              ...
                              $q = "SELECT * FROM raise_stat where (request_id = '$dock_num')";
                                ...
                                <div class="well">
                                  <div id="ConvDetails" >
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-3">
                                        <h5>Items : <?php echo $rowSearch['sta_item'] ?></h5>
                                        <h5>Quantity : <?php echo $rowSearch['quantity'] ?> Nos</h5>
                                      </div>
                                      <div class="col-lg-6">
                                        <h5>Status : <?php echo $rowSearch['req_status'] ?></h5>
                                        <h5>Remarks : <?php echo $rowSearch['remarks'] ?></h5>
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="col-lg-12">
                                        <h5>Comments : <?php echo $rowSearch['comments'] ?> Nos</h5>
