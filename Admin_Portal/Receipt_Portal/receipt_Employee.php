						...
						<div id="print_setion" style="padding: 15px;margin-top: 5px;margin-bottom: 20px;">
							<div class="row">
								<div class="col-lg-12">
									<table class="tablePrint" border="0" width="100%">
										<tbody>
											<tr>
												<td>
													<h4 style="text-align: center;padding-top: 15px;">Employee Profile Receipt</h4>
												</td>
											</tr>
										</tbody>
									</table>
									<table class="tablePrint" border="0" width="100%">
										<tbody>
											<tr>
												...
												<td width="100px"><img src="<?php echo $upload_dir.$rowMember['image'] ?>" class="img-responsive" height="100px" width="100px"></td>
											</tr>
										</tbody>
									</table>
									...
									<table class="tablePrint"  style="padding-bottom: 20px; padding-top: 20px;" border="0" width="100%">
										<tbody>
											<tr><?php
												...
												?>
												<td><p><b>Employee Address </b><br>C/o,<?php echo $rowMember['firstName'] ?> <?php echo $rowMember['lastName'] ?>,<?php echo $rowMember['present_address'] ?><br><?php echo $rowMember['state'] ?>,<?php echo $rowMember['present_pincode'] ?></p>
											</td>
											<td>
								...
								<table class="tablePrint" border="1" width="100%">
									...
									<tbody>
										<tr>
											...
											<td><?php echo $rowMember['medicalHistory'] ?></td>
								...
								<table class="tablePrint" border="1" width="100%">
									...
									<tbody>
										<tr>
											<td><?php echo $rowMember['highestQual'] ?></td>
											<td><?php echo $rowMember['colUniversity'] ?></td>
											<td><?php echo $rowMember['degree'] ?></td>
											<td><?php echo $rowMember['passingDate'] ?></td>
										</tr>
									</tbody>
								</table><br>
