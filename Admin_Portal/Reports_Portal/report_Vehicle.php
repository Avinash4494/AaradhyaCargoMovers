          ...
          <div class="col-lg-12">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="report_index.php" data-toggle="tooltip" title="Reports Portal!" data-placement="top" >Reports Portal</a> / <span class="activePage"> Vehicles Report</span> </h5>
              </div>
                    ...
                    <table class="css-serial table table-hover" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td ></td>
                          <td><b><a style="color: black;" href="../Vehicle_Portal/vehicle_View.php?id=<?php echo $rowMember['id'] ?>" data-toggle="tooltip" title="View" data-placement="left"><?php echo $rowMember['vehicle_id'] ?></a></b></td>
                ...
                <div class="row" >
                  <div class="col-lg-8 col-xs-12"  >
                    <div class="pagination" >
                      <?php
                      $query = "SELECT COUNT(*) FROM add_vehicle";
                      $rs_result = mysqli_query($connect, $query);
                      ...
                      $pagLink = "";
                      if($page>=2){
                      echo "<a style='border:none;' href='report_Vehicle.php?page=".($page-1)."'>  <i class='fa fa-backward'></i> </a>";
                      }
                      for ($i=1; $i<=$total_pages; $i++) {
                      if ($i == $page) {
                      $pagLink .= "<a class = 'active' href='report_Vehicle.php?page="
                      .$i."'>".$i." </a>";
                      }
                      else  {
                      $pagLink .= "<a href='report_Vehicle.php?page=".$i."'>
                      ".$i." </a>";
                      }
                      };
                      echo $pagLink;
                      if($page<$total_pages){
                      echo "<a style='border:none;' href='report_Vehicle.php?page=".($page+1)."'>  <i class='fa fa-forward'></i> </a>";
                      }
                      ?>
                    </div>
                  </div>
