        ...
        <div class="col-lg-12">
          <div class="rightPannel">
            <div class="paggignation">
              <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="report_index.php" data-toggle="tooltip" title="Reports Portal!" data-placement="top" >Report Portal</a> / <span class="activePage"> Sales Report</span> </h5>
            </div>
...
<div class="row">
  ...
  <div class="col-lg-1">
   <button class="actionButtonIcons-center" onclick="printDivSection('print_setion')" type="submit">Print</button>
  </div>
</div>
        <div class="row">
                  <div class="col-lg-12">
...
.css-serial td:first-child:before {
  ...
  content: counter(serial-number);  /* Display the counter */
                            ...
                            <tbody>
                              ...
                              <td ><a href="member_View.php?id=<?php echo $rowMember['id'] ?>" >
                                <button class="actionButtonIcons-center" type="submit"><i  class="fa fa-eye" aria-hidden="true"></i></button>
                              </a></td>
                            </tr>
                            <?php
                            }
