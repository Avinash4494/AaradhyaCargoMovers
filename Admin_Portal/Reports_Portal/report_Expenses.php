          ...
          <div class="col-lg-12">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="report_index.php" data-toggle="tooltip" title="Members Portal!" data-placement="top" >Report Portal</a> / <span class="activePage"> Expenses Report</span> </h5>
              </div>              
              <div id="print_setion">
                <!-- Your Code Here -->
                <div class="row">
                  ...
                  <div class="col-lg-1">
                    <button class="actionButtonIcons-center" type="submit">Print</button>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12">
