          ...
          <div class="col-lg-12">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="report_index.php" data-toggle="tooltip" title="Reports Portal!" data-placement="top" >Report Portal</a> / <span class="activePage"> Equipments Report</span> </h5>
              </div>
              ...
              <div id="print_setion">
                ...
                <div class="row">
                  <div class="col-lg-11">
                    <h4>Equipments Report Details</h4>
                  </div>
                  <div class="col-lg-1">
