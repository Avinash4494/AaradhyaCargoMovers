          ...
          <div class="col-lg-10">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="trace_index.php" data-toggle="tooltip" title="Finder Portal!" data-placement="top">Finder Portal</a> / <span class="activePage">Quote Search</span></h5>
              </div>
              ...
              <div class="bodyComponent">
                <form action="trace_quote.php" method="post">
                  <div class="row">
                    <div class="col-lg-2">
                    </div>
                    <div class="col-lg-8">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="word"  name="quote_id"  autocomplete="off" placeholder="Enter Quote ID"  required="">
                      </div>
                ...
                <div id="priint_setion">
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      ...
                      $q = "SELECT * FROM quote where (quote_id = '$quote_id')";
