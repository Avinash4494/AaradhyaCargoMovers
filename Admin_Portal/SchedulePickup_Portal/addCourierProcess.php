...
if(empty($docketNumber)){
		...
		if(!isset($errorMsg)){
			$sql = "insert into member_add_courier (courier_id,user_id,pickup_id,cus_name,cus_address,cus_contact,cus_gstin,invoice_date,invoice_no,courierdate,docketNumber,nofpkts,mode,payment_process,order_status,order_date,package_from,package_to,rate,total_weight,frieght_charge,pickup_charge,docket_charge,gst,gst_range,grand_total,added_date,image)
					values('".$courier_id_gen."','".$user_id."','".$pickup_id."','".$cus_name."','".$cus_address."','".$cus_contact."','".$cus_gstin."','".$invoice_date."','".$invoice_no."','".$courierdate."','".$docketNumber."','".$nofpkts."','".$mode."','".$payment_process."','".$order_status."','".$order_date."','".$package_from."','".$package_to."','".$rate."','".$total_weight."','".$frieght_charge."','".$pickup_charge."','".$docket_charge."','".$gst."','".$gst_range."','".$grand_total."','".$added_date."','".$userPic."')";
