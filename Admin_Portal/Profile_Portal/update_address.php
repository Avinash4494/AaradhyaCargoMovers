    ...
    <div class="wrapper">
      ...
      <!--                                 <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" id="present_address" name="present_address" class="form-control"  placeholder="Your Communication Address">
                                      </div>
 ...
 <!--                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" id="present_pincode" name="present_pincode" class="form-control"  placeholder="Pin Code">
                                            ...
                                            <div class="form-group">
                                            <label for="">Address<span>*</span></label>
                                            <input type="text" id="permanent_address" name="permanent_address" class="form-control" placeholder="Your Permanent Address"  placeholder="Your Address">
                                          </div>
                                          <div class="form-group">
                                            <label for="">State<span>*</span></label>
