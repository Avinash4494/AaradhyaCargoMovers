...
echo '<script>
setTimeout(function(){ window.location.href="updatedSuccessBank.php"; }, 500);
</script>';
}else{
          ...
          <div class="col-lg-10">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="index.php" data-toggle="tooltip" title="Profile Portal!" data-placement="top">Profile Portal</a> / <span class="activePage">Update Bank Details</span> </h5>
              </div>
              <div id="print_setion">
                <!-- Your Code Here -->
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-lg-4 col-xs-12">
                                      <div class="form-group">
                                        ...
                                        <input type="text" id="dob" name="record_name" placeholder="Name as per records" class="form-control" value="<?php echo $row['record_name']?>">
                                      </div>
                                    </div>
                                    <div class="col-lg-4 col-xs-12">
                                      <div class="form-group">
