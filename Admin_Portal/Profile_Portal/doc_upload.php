...
$id = $_GET['delete'];
$sql = "select * from admin_upload_doc where id = ".$id;
$result = mysqli_query($connect, $sql);
if(mysqli_num_rows($result) > 0){
$row = mysqli_fetch_assoc($result);
$image = $row['image1'];
unlink($upload_dir.$image);
$sql = "delete from admin_upload_doc where id=".$id;
					...
					<div class="col-lg-10">
						<div class="rightPannel">
							<div class="paggignation">
								<h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> /<a href="index.php" data-toggle="tooltip" title="Profile Portal" data-placement="top"> Profile Portal</a> / <span class="activePage">Upload Documents</span></h5>
							</div>
							...
							<div class="row">
								<div class="col-lg-12">
									<h5>My Documents</h5>
									<?php
									$query = "SELECT * FROM admin_upload_doc WHERE employees_id='$employees_id'";
