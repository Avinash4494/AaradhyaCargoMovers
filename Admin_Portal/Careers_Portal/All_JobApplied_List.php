...
echo '<script>
setTimeout(function(){ window.location.href="All_JobApplied_List.php"; }, 1000);
</script>';
}
}
}
          ...
          <div class="col-lg-10">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="career_index.php" data-toggle="tooltip" title="Careers Portal!" data-placement="top" >Careers Portal</a> / <span class="activePage"> Application Forms </span> </h5>
              </div>
              <div id="print_setion">
                   ...
                   <table class="css-serial table table-hover" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><b><a style="color: black;" href="career_application_view.php?id=<?php echo $rowMember['id'] ?>" data-toggle="tooltip" title="View" data-placement="left"><?php echo $rowMember['registration_id'] ?></a></b></td>
                        ...
                        <td>
                          <a href="All_JobApplied_List.php?delete=<?php echo $rowMember['id'] ?>" onclick="return confirm('Are you sure to delete this record?')">
