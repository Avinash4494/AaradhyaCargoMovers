          ...
          <div class="col-lg-12">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="payment_Index.php" data-toggle="tooltip" title="Payments Portal!" data-placement="top" >Payments Portal</a> / <span class="activePage">Pending Payments</span> </h5>
              </div>
 ...
 <!-- Report Code Here -->
        <table class="css-serial table table-hover" width="100%">
          ...
          <tbody>
           ...
           <td><a href="payment_Fee_Receipt.php?id=<?php echo $rowMember['id'] ?>"><button class="actionButtonIcons-center" type="submit"><i class="fa fa-print"></i></button></a></td>
          </tr>
          <?php
                            }
                            }
