...
echo '<script>
setTimeout(function(){ window.location.href="All_Account_List.php"; }, 1000);
</script>';
}
}
}
          ...
          <div class="col-lg-10">
            <div class="rightPannel">
              <div class="paggignation">
                <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="admin_index.php" data-toggle="tooltip" title="Accounts Portal!" data-placement="top" >Accounts Portal</a> / <span class="activePage"> Accounts List</span> </h5>
              </div>
              <div id="print_setion">
                      ...
                      <table class="css-serial table table-hover" width="100%">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="account_View.php?id=<?php echo $rowMember['id'] ?>" >
                              <button class="actionButtonIcons-center" type="submit"><i class="fa fa-eye"></i></button>
                            </a>
                          </td>
                          <td>
                            <a href="All_Account_List.php?delete=<?php echo $rowMember['id'] ?>" onclick="return confirm('Are you sure to delete this record?')">
