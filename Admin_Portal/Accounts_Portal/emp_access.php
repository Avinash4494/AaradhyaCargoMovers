...
echo '<script>
setTimeout(function(){ window.location.href="emp_access.php"; }, 1000);
</script>';
}
}
}
                ...
                <div class="row">
                  <div class="col-lg-8">
                    <div class="paggignation">
                      <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="admin_index.php" data-toggle="tooltip" title="Accounts Portal!" data-placement="top" ></a>Accounts Portal / <span class="activePage"> Employee Access</span> </h5>
                    </div>
                  </div>
                  <style>
                  ...
                  <div class="col-lg-2">
                    <a href="approval_Access.php">
                      <button class="actionButtonIcons" style="border:1px solid #1c2833;"  type="submit"><i class="fa fa-user"></i>&nbsp &nbsp Admin Access</button>
                    </a>
                  </div>
                  <div class="col-lg-2">
                    <a href="">
                      <button class="actionButtonIcons" style="background-color: white;color: #1c2833;border:1px solid #1c2833;"  type="submit"><i class="fa fa-briefcase"></i>&nbsp &nbsp Employee Access</button>
                    </a>
                  </div>
                </div>
              </div>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="approval_edit_Emp.php?id=<?php echo $rowMember['id'] ?>">
