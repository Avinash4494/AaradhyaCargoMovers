...
echo '<script>
setTimeout(function(){ window.location.href="approveSuccess.php"; }, 500);
</script>';
}else{
                            ...
                            <div class="row">
                               <div class="col-lg-3 col-xs-12" >
                                ...
                                <div class="form-group">
                                  <input type="text" class="form-control" id="weight" name="approved_By" value="<?php echo $rowedit['approved_By'] ?>">
                                </div>
                              </div>
                              <div class="col-lg-3 col-xs-12">
