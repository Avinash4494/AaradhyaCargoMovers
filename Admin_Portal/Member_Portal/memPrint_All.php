					...
					<div class="col-lg-10">
						<div class="rightPannel">
							<div class="paggignation">
								<h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="member_index.php" data-toggle="tooltip" title="Members Portal!" data-placement="top" >Members Portal</a> / <span class="activePage"> All Member Details</span> </h5>
							</div>
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<table class="tablePrint" border="1" width="100%" style="margin: 15px 0px;">
											...
											?>
											<tr>
												<td><?php echo $rowMember['user_id'] ?></td>
												<td><?php echo $rowMember['coy_name'] ?></td>
												<td><?php echo $rowMember['coy_email'] ?></td>
												<td><?php echo $rowMember['coy_phone'] ?></td>
												<td><?php echo $rowMember['coy_mobile'] ?></td>
