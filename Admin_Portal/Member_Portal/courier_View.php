            ...
            <div class="rightPannel">
              <div class="row">
                <div class="col-lg-10">
                  <div class="paggignation">
                    <h5><a href="../AdminDashboard.php" data-toggle="tooltip" title="Dashboard!" data-placement="top">Dashboard</a> / <a href="member_index.php" data-toggle="tooltip" title="Members Portal!" data-placement="top" >Members Portal</a> / <span class="activePage"> Courier Invoice</span> </h5>
                  </div>
                </div>
                <div class="col-lg-1">
                  <!-- <a href="member_View.php">
                    <button class="actionButtonIcons-center" style="margin-top: 5px;"type="submit"><i class="fa fa-arrow-left"></i></button>
                  </a> -->
                </div>
                <div class="col-lg-1">
                  <button class="actionButtonIcons-center" style="margin-top: 5px;"  onclick="printDivSection('print_setion')" type="submit"><i class="fa fa-print"></i></button>
                </div>
              </div>
              <div class="bodyComponent">
                <div class="widgetShipmentComp">
                  <div class="well">
                    <!-- PRINT SECTION -->
                    <div id="print_setion" style="border:2px solid black;padding: 10px; margin-top: 20px;">
